...
+ מזהה (למשל `my-cool-bot-42`) - ולכן שמות אפליקציות חייבים להיות
ייחודיים גלובלית (לא רק מול האפליקציות שלכם, מול כולם), כדי שאף אחד
לא "יגנוב" כתובת של מישהו אחר. אם האפליקציה לא רצה, או שהיא רצה אבל
