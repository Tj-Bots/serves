...
יש כפתור החלפת שפה (עברית/אנגלית) וכפתור מצב כהה/בהיר בתפריט העליון.
הבחירה נשמרת בסשן (שפה) וב-localStorage של הדפדפן (ערכת נושא), בלי צורך
בהגדרה נוספת בשרת. הטרמינל של הלוגים נשאר תמיד כהה גם במצב בהיר (כמו כל
טרמינל אמיתי).
