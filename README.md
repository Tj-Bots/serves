...
בעמוד כל אפליקציה יש כפתור "פתח אפליקציה" שמעביר ל-`/open/<app_id>` -
נתיב **ציבורי** (בלי צורך בהתחברות, בדיוק כמו אתר רגיל) שמזרים תעבורת
HTTP ישירות לקונטיינר של האפליקציה. אם האפליקציה לא רצה, או שהיא רצה
אבל לא מאזינה בכלל על הפורט הזה (למשל כי היא "רק" בוט טלגרם בלי אתר),
...
תת-נתיב (`/open/<id>/...`) ולא סאב-דומיין ייעודי - מסגרות עבודה
